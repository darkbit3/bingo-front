    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 lg:p-8 max-w-sm lg:max-w-md w-full shadow-2xl border-2 border-green-500/50 relative">
        ...
        <div className="text-center mb-4">
          <div className="text-gray-400 text-sm mb-3">Player: P7410</div>
          ...
          <div className="text-3xl lg:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600">$192</div>
        </div>
